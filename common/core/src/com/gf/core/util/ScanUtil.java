...
/**
* <p>ScanUtil is used to locate classes that are available in the/a class path and meet
...
* {@link #find(org.apache.AbstractTest.io.ScanUtil.Test, String)} ()} method and supplying
* a package name and a Test instance. This will cause the named package <b>and all sub-packages</b>
* to be scanned for classes that meet the test. There are also utility methods for the common
* use cases of scanning multiple packages for extensions of particular classes, or classes
* annotated with a specific annotation.</p>
* <p/>
* <p>The standard usage pattern for the ScanUtil class is as follows:</p>
* <p/>
* <pre>
* ScanUtil&lt;ActionBean&gt; resolver = new ScanUtil&lt;ActionBean&gt;();
...
* @author Tim Fennell
*/
public class ScanUtil<T> {
	/**
	 * An instance of Log to use for logging in this class.
	 */
	private static final Log log = LogFactory.getLog(ScanUtil.class);
	 ...
	 * are to be included in the results produced by the ScanUtil.
	 */
	 ...
	 */
	public ScanUtil<T> findImplementations(Class<?> parent, String... packageNames) {
	 ...
	 * @param packageNames one or more package names to scan (including subpackages) for classes
	 */
	public ScanUtil<T> findAnnotated(Class<? extends Annotation> annotation, String... packageNames) {
		if (packageNames == null) return this;
	 ...
	 */
	public ScanUtil<T> find(Test test, String packageName) {
